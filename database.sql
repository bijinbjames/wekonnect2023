...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2022 at 05:09 PM
...
(1, 'siteName', 'WeKonnekt'),
(2, 'siteTitle', 'WeKonnekt'),
(3, 'siteKeywords', 'social, WeKonnekt, social site'),
(4, 'siteDesc', 'WeKonnect is a Referral Platform'),
(5, 'siteEmail', 'rahul.paul118@gmail.com'),
...
(227, 'last_notification_delete_run', '1645546002'),
...
(530, 'what_are_you_looking_for', '', 'What are you looking for ?', 'عن ماذا تبحث؟', 'Wat zoekt?', 'Que cherchez?', 'Was suchst du?', 'Quello che sono in cerca di ?', 'O que voc&amp;ecirc; esta procurando ?', 'Что вы ищете?', '¿Que están buscando ?', 'Ne arıyorsun?'),
